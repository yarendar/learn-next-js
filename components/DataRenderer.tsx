...
const StateSkeleton = ({
  ...
  <div className="mt-16 flex w-full flex-col items-center justify-center sm:mt-16">
    <>
      <Image
        src={image.dark}
        alt={image.alt}
    ...
    <p className="body-regular text-dark500_light700 m-3.5 max-w-md text-center">
      {message}
    </p>
